...
#============================# date base id + 1
sql = "INSERT INTO date_and_time (dataTime)\
            VALUES (%s)"
with connection.cursor() as cursor:
    now = datetime.datetime.now()
    r = cursor.execute(sql, (now))
connection.commit()
...
while 1:
    ...
    try:
        ...
        if(log_len>=375 and log_len<=400 ):
            ...
            ys[id_data] = cl.OrderedDict({"RM1": json_log['RM1'],"RM2":json_log['RM2'],"RM3":json_log['RM3'],"RM4":json_log['RM4'],"RM5":json_log['RM5'],"RM6":json_log['RM6'],
